...
public:
    ...
    static QJsonObject dataToJson(const QString & type, const void * buf, int nbyte);
    static bool dataFromJson(const QJsonObject & object, const QString & type, void * buf, int nbyte);
